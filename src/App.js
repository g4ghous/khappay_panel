...
import GridSubCategories from "./component/GridSubCategories";
      ...
      <div>
        <Router>
          ...
          <div className="container">
            ...
            <Route
              path="/component/GridGuidelines"
              component={GridGuidelines}
            />
            <Route path="/component/GridFavourite" component={GridFaourites} />
            <Route
              path="/component/GridFavourites"
              component={GridFavourites}
            />
            ...
            <Route
              path="/component/gridBusinessUsers"
              component={GridBusinessUsers}
            />
            <Route path="/component/GridProducts" component={GridProducts} />
            <Route path="/component/GridOrders" component={GridOrders} />
            <Route
              path="/component/GridCategories"
              component={GridCategories}
            />
            <Route
              path="/component/GridSubCategories"
              component={GridSubCategories}
            />
            ...
            <Route
              path="/component/CreateGuidelines"
              component={CreateGuidelines}
            />
            <Route path="/component/CreateEvents" component={CreateEvents} />
            <Route
              path="/component/CreateEventType"
            ...
            <Route
              path="/component/createBusinessUser"
              component={CreateBusinessUser}
            />
            ...
            />
            <Route
              path="/component/createSubCategory"
            ...
            <Route
              path="/component/ViewGuidelines"
              component={ViewGuidelines}
            />
            <Route path="/component/ViewEvents" component={ViewEvents} />
            <Route path="/component/ViewSlider" component={ViewSlider} />

            <Route
              path="/component/ViewSystemBusinessUser"
              component={ViewSystemBusinessUser}
            />
            ...
            <Route
              path="/component/UpdateEventType"
            ...
            <Route
              path="/component/UpdateGuidelines"
            ...
            <Route
              path="/component/updateBusinessUser"
